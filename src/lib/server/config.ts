...
const envSchema = z.object({
  ...
  MANUAL_PAYMENT_QR_URL: z.string().optional().default(""),
  MANUAL_PAYMENT_TITLE: z.string().optional().default("扫码付款后联系管理员加额度"),
  MANUAL_PAYMENT_DESCRIPTION: z.string().optional().default("请备注注册邮箱或订单信息，管理员确认到账后会手动为你的账户添加额度。"),
...
export const getServerConfig = () => {
  ...
  return {
    ...
    manualPaymentQrUrl: env.MANUAL_PAYMENT_QR_URL,
    manualPaymentTitle: env.MANUAL_PAYMENT_TITLE,
    manualPaymentDescription: env.MANUAL_PAYMENT_DESCRIPTION,
